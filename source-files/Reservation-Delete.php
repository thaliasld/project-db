	<?php	
		...
		if ($LicensePlate==='' or $StartDate===''){header('Location:Reservation-Delete.html');exit;}
		$LicensePlate=" LicensePlate='$LicensePlate'";
		$StartDate=" StartDate='$StartDate'";
		$result = mysqli_query($con, "DELETE FROM reserves WHERE ".$LicensePlate." AND".$StartDate);
		if($result === FALSE) {
			die(mysqli_error($con)); 
		}

		mysqli_close($con);
		$link = 'Reservation-Delete.html';
	?>	
