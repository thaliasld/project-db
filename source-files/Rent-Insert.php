	<?php	
		...
		$result = mysqli_query($con, "INSERT INTO `rents` (`LicensePlate`, `StartDate`, `StartLocation`, `FinishLocation`, `FinishDate`, `ReturnState`, `CustomerID`, `IRS_Num`)
		VALUES ('$LicensePlate', '$StartDate', '$StartLocation', '$FinishLocation', '$FinishDate', '$ReturnState',$CustomerID, $IRS_Num)");
