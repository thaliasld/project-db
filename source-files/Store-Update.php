	<?php	
		...
		if ($Street==='' or $StreetNum==='' or $PostalCode==='' or $City===''){
			header('Location:Store-Update.html');
			exit;
		}
		
		$result = mysqli_query($con, "UPDATE store SET Street='$Street', StreetNum=$StreetNum, PostalCode=$PostalCode, City='$City' WHERE StoreID=$StoreID");
