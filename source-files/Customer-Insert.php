	<?php	
		...
		$result = mysqli_query($con, "INSERT INTO `customer` (`IRS_Num`, `LastName`, `FirstName`, `SSN`, `Driver_License`, `FirstRegistrationCity`, `City`, `Street`, `StreetNum`, `PostalCode`) VALUES ($IRS_Num, '$LastName', '$FirstName', $SSN, '$Driver_License', '$FirstRegistrationCity', '$City', '$Street', $StreetNum, $PostalCode)");
