	<?php	
		...
		if ($LicensePlate==='' or $FuelType===''){
			header('Location:Fuel-Insert.html');
			exit;
		}
		
		$result = mysqli_query($con, "UPDATE fueltype SET LicensePlate='$LicensePlate', FuelType='$FuelType' WHERE LicensePlate='$LicensePlate'");
