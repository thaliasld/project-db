...
<?php
		...
		$result = mysqli_query($con, "SELECT LicensePlate, COUNT(*) As \"Times Rented\" FROM rents
GROUP BY LicensePlate;");
		...
		echo "<td>";echo "<strong>";echo "Times Rented";echo "</strong>";echo "</td>";
		echo "</tr>";
		
		while($row = mysqli_fetch_array($result)) {
		echo "<tr>";
		echo "<td>";echo $row['LicensePlate'];echo "</td>";
		echo "<td>";echo $row['Times Rented'];echo "</td>";
		echo "</tr>";
		}
		echo "</table>";
		mysqli_close($con);	
