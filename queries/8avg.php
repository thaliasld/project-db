...
<?php
		...
		$result = mysqli_query($con, "SELECT ROUND(AVG(Kilometers),2) FROM vehicle;");
		if($result === FALSE) { 
		...
		echo "<tr>";
		echo "<td>";echo "<strong>";echo "Average Kilometers";echo "</strong>";echo "</td>";
		echo "</tr>";
		
		while($row = mysqli_fetch_array($result)) {
		echo "<tr>";
		echo "<td>";echo $row['ROUND(AVG(Kilometers),2)'];echo "</td>";
		echo "</tr>";
		}
		echo "</table>";
		mysqli_close($con);	
